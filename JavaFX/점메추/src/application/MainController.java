...
public class MainController {
    ...
    void initData() {
    	...
    	= Arrays.asList("국밥","규카츠","김밥","돈까스","떡볶이",
    					"마라탕","부대찌게","삼겹살","쇼좌빙","스테이크",
    					"우동","육회","초밥","치킨","카레",
    					"텐동","파스타","피자","함박스테이크","햄버거");
    	List<String> imgList 
    	= Arrays.asList("국밥.png","규카츠.jpg","김밥.jpg","돈까스.jpg","떡볶이.jpg",
    					"마라탕.jpg","부대찌게.jpg","삼겹살.jpg","쇼좌빙.jpg","스테이크.jpg",
    					"우동.jpg","육회.jpg","초밥.jpg","치킨.png","카레.jpg",
    ...
    public void initTimer() {
    	...
    	rotate.setCycleCount( Timeline.INDEFINITE ); // 계속 반복
    	
    	// 3초 뒤에 메뉴 고르는 타이머
    	stop = new Timeline(
    		new KeyFrame( Duration.millis(3000), e -> rotate.stop() )    	
    	);
    	stop.setCycleCount(1); // 한번만 반복	
    }
